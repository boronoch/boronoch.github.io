// Define two sets of tasks for each column
const tasksColumn1 = [
...
// Update all tasks based on the selected column
...
// Set up the column selector to change the displayed column
